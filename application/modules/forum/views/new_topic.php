				...
				<div class="uk-grid uk-grid-small">
					<div class="uk-width-expand@m">
						<h4 class="uk-h4 uk-text-bold"><i
								class="fas fa-pen-square"></i> <?= $this->lang->line('button_new_topic'); ?></h4>
					</div>
					<div class="uk-width-auto@m">
						<a href="<?= base_url('forum'); ?>" class="uk-button uk-button-default uk-button-small"><i
				...
				<div class="uk-margin uk-light">
					...
					<div class="uk-form-controls">
						<div class="uk-inline uk-width-1-1">
							...
							<input class="uk-input" type="text" id="topic_title"
						...
						<div class="uk-form-controls">
							<div class="uk-grid uk-grid-small uk-child-width-auto uk-flex uk-flex-center" data-uk-grid>
								<label><input class="uk-checkbox" type="checkbox"
											  id="topic_pinned"> <?= $this->lang->line('placeholder_highl'); ?></label>
								<label><input class="uk-checkbox" type="checkbox"
											  id="topic_locked"> <?= $this->lang->line('placeholder_lock'); ?></label>
							</div>
						</div>
					</div>
				<?php endif; ?>
				<div class="uk-margin">
					<button class="uk-button uk-button-default uk-width-1-1" type="submit" id="button_topic"><i
