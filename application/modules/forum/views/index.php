                  ...
                  <tr>
                    ...
                    <td class="uk-width-medium">
                      <?php foreach ($this->forum_model->getLastPostCategory($sections->id)->result() as $lastpost): ?>
                        ...
                        by <span class="uk-text-primary"><a href="<?= base_url('profile/'.$lastpost->author); ?>" class="uk-link-reset"><?= $this->wowauth->getUsernameID($lastpost->author) ?> </a> </span>
                      <?php endforeach; ?>
                    </td>
                  </tr>
              ...
              <div class="uk-card-body">
                <ul class="uk-list uk-list-divider">
                  ...
                  <li>
                    ...
                    <p class="uk-text-small uk-margin-remove"><?= $this->lang->line('forum_last_post_by'); ?> <span class="uk-text-primary"><a href="<?= base_url('profile/'.$lastest->author); ?>" class="uk-link-reset"><?= $this->wowauth->getUsernameID($lastest->author) ?> </a></span></p>
                    ...
                    <p class="uk-text-small uk-margin-remove"><?= $this->lang->line('forum_last_post_by'); ?> <span class="uk-text-primary"><<a href="<?= base_url('profile/'.$lastest->author); ?>" class="uk-link-reset"><?= $this->wowauth->getUsernameID($replies->author) ?> </a></span></p>
