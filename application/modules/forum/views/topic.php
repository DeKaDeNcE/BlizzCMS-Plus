          ...
          <div class="uk-card-body">
            <div class="uk-grid uk-grid-small" data-uk-grid>
              <div class="uk-width-1-6@s">
                <div class="Author <?php if($this->wowauth->getRankWeb($this->forum_model->getSpecifyPostAuthor($idlink)) > 1) echo 'topic-author-staff'; ?> uk-flex uk-flex-center">
        ...
        <div class="uk-grid uk-grid-small uk-child-width-1-1 uk-margin" data-uk-grid>
          ...
          <div>
            <div class="uk-card uk-card-default uk-card-body">
              <div class="uk-grid uk-grid-small" data-uk-grid>
                <div class="uk-width-1-6@s">
                  <div class="Author <?php if($this->wowauth->getRankWeb($commentss->author) > 1) echo 'topic-author-staff'; ?> uk-flex uk-flex-center">
                    <div class="topic-author-avatar profile">
                  ...
                  <?php if($this->wowauth->getRankWeb($commentss->author) > 1): ?>
                <div class="author-rank-staff"><i class="fas fa-fire"></i> Staff</div>
                  <?php endif; ?>
                </div>
                <div class="uk-width-expand@s">
                  ...
                  <?php if($this->wowauth->getRankWeb($this->session->userdata('wow_sess_id')) > 1 || $this->session->userdata('wow_sess_id') == $commentss->author && $this->wowgeneral->getTimestamp() < strtotime('+30 minutes', $commentss->date)): ?>
          ...
          <?php endforeach; ?>
          <?php if(!is_logged() && $this->forum_model->getTopicLocked($idlink) == 0): ?>
          <div>
            <div class="uk-card uk-card-default uk-card-body">
