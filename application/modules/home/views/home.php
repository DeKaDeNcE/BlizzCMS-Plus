    <section class="uk-section uk-padding-remove slider-section">
      <?php if($this->wowmodule->getModule(3)): ?>
      ...
      <div class="uk-container">
        <div class="uk-grid uk-grid-medium uk-margin-small" data-uk-grid>
          <div class="uk-width-2-3@s">
            <?php if ($this->wowmodule->getModule(10)): ?>
          ...
          <div class="uk-width-1-3@s">
            <?php if($this->wowmodule->getModule(4)): ?>
            ...
            <?php endif ?>
            <?php if ($this->wowmodule->getModule(1) == '1' && $this->config->item('discord_type') == '1'): ?>
            ...
            <?php endif ?>
            <?php if ($this->wowmodule->getModule(1) == '1' && $this->config->item('discord_type') == '2'): ?>
            <h4 class="uk-h4 uk-text-bold"><i class="fab fa-discord fa-sm"></i> <?= $this->lang->line('home_discord'); ?></h4>
            <div class="uk-text-center uk-margin-small">
