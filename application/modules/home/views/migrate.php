		...
		<div class="uk-container">
			<nav class="uk-navbar" uk-navbar>
				<div class="uk-navbar-left">
					<a target="_blank" href="https://wow-cms.com" class="uk-navbar-item uk-logo">BlizzCMS<sup
							class="uk-text-success">+</a>
				</div>
				<div class="uk-navbar-right">
					<div class="uk-navbar-item">
						<a target="_blank" href="https://gitlab.com/WoW-CMS"
						   class="uk-icon-button gitlab uk-margin-small-right"><i class="fab fa-gitlab"></i></a>
						<a target="_blank" href="https://discord.gg/vZG9vpS" class="uk-icon-button discord"><i
	...
	<div class="uk-container">
		<div class="uk-grid uk-grid-small" data-uk-grid>
			...
			<div class="uk-width-1-2@s">
				...
				<p class="uk-text-small uk-text-center uk-margin-remove-top uk-margin-bottom">Complete this last step to
					finish the migration of <span class="uk-text-bold">BlizzCMS<sup
							class="uk-text-success">+</sup></span></p>
				<?= form_open('', 'id="migrateForm" onsubmit="MigrateForm(event)"'); ?>
				<h5 class="uk-h5 uk-heading-line uk-margin-small uk-text-uppercase uk-text-bold"><span><i
							class="fas fa-sync fa-spin"></i> Website Settings</span></h5>
				<div class="uk-margin-small uk-light">
					<div class="uk-grid uk-grid-small" data-uk-grid>
						...
						<div class="uk-inline uk-width-1-2@s">
							...
							<div class="uk-form-controls">
								<input class="uk-input" type="text" id="website_realmlist"
									   placeholder="logon.domain.com" required>
							</div>
						</div>
					</div>
				</div>
				<div class="uk-margin-small uk-light">
					<div class="uk-grid uk-grid-small" data-uk-grid>
						...
						<div class="uk-inline uk-width-1-2@s">
							...
							<div class="uk-form-controls">
								<input class="uk-input" type="text" id="website_invitation" pattern=".{,7}"
									   placeholder="WGGGVgX" required>
							</div>
						</div>
					</div>
				</div>
				<div class="uk-margin-small uk-light">
					...
					<div class="uk-form-controls">
						<input class="uk-input" type="text" id="website_license" placeholder="XXXXX-XXXXX-XXXXX-XXXXX"
							   pattern="^[A-Z0-9]{5,}-?[A-Z0-9]{5,}-?[A-Z0-9]{5,}-?[A-Z0-9]{5,}$" required>
					</div>
				</div>
				<div class="uk-margin">
					<button class="uk-button uk-button-primary uk-width-1-1 uk-margin-small-bottom" type="submit"
							id="button_migrate"><i class="fas fa-sync fa-spin"></i> Finish Migration
					</button>
				</div>
				<?= form_close(); ?>
				<script>
...
<section class="uk-section uk-section-xsmall">
	<div class="uk-container">
		<h5 class="uk-h5 uk-text-center uk-margin-remove">Copyright <i class="far fa-copyright"></i> <?= date('Y'); ?>
			<span class="uk-text-bold">WoW-CMS</span>. All rights reserved</h5>
	</div>
</section>
</body>
</html>
