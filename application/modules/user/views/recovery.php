...
<section class="uk-section uk-section-xsmall main-section" data-uk-height-viewport="expand: true">
	<div class="uk-container">
		<h4 class="uk-h4 uk-heading-line uk-text-uppercase uk-text-bold"><span><i
					class="fas fa-user-cog"></i> <?= $this->lang->line('tab_reset'); ?></span></h4>
		...
		<div class="uk-margin-small uk-light">
			<div class="uk-form-controls">
				<div class="uk-inline uk-width-1-1">
					...
					<input class="uk-input" type="text" id="recovery_username"
		...
		<div class="uk-margin uk-light">
			<div class="uk-form-controls">
				<div class="uk-inline uk-width-1-1">
					...
					<input class="uk-input" type="email" id="recovery_email"
		...
		<div class="uk-grid uk-grid-small uk-grid-margin-small" data-uk-grid>
			...
			<div class="uk-width-1-4@m">
				<button class="uk-button uk-button-default uk-width-1-1" id="button_recovery" type="submit"><i
						class="fas fa-paper-plane"></i> <?= $this->lang->line('button_send'); ?></button>
			</div>
		</div>
		<?= form_close(); ?>
	</div>
