			...
			<div class="uk-width-1-4@s">
				<div class="uk-card uk-card-secondary">
					<ul class="uk-nav uk-nav-default">
						<li><a href="<?= base_url('admin/forum'); ?>"><i
									class="fas fa-tags"></i> <?= $this->lang->line('section_forum_categories'); ?></a>
						</li>
						<li class="uk-active"><a href="<?= base_url('admin/forum/elements'); ?>"><i
									...
									<tr>
										...
										<td>
											<div class="uk-flex uk-flex-left uk-flex-center@m uk-margin-small">
												<a href="<?= base_url('admin/forum/edit/' . $list->id); ?>"
												...
												<button class="uk-button uk-button-danger" value="<?= $list->id ?>"
														...
														onclick="DeleteForum(event, this.value)"><i
