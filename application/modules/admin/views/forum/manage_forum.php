	...
	<div class="uk-container">
		<div class="uk-grid uk-grid-small uk-margin-small" data-uk-grid>
			<div class="uk-width-expand uk-heading-line">
				<h3 class="uk-h3"><i class="fas fa-bookmark"></i> <?= $this->lang->line('admin_nav_manage_forum'); ?>
				</h3>
			</div>
			<div class="uk-width-auto">
				<a href="<?= base_url('admin/forum/category/create'); ?>" class="uk-icon-button"><i
			...
			<div class="uk-width-1-4@s">
				<div class="uk-card uk-card-secondary">
					<ul class="uk-nav uk-nav-default">
						<li class="uk-active"><a href="<?= base_url('admin/forum'); ?>"><i
									class="fas fa-tags"></i> <?= $this->lang->line('section_forum_categories'); ?></a>
						</li>
						<li><a href="<?= base_url('admin/forum/elements'); ?>"><i
									class="fas fa-comment-dots"></i> <?= $this->lang->line('section_forum_elements'); ?>
							</a></li>
					</ul>
				</div>
			</div>
									...
									<tr>
										...
										<td>
											<div class="uk-flex uk-flex-left uk-flex-center@m uk-margin-small">
												<a href="<?= base_url('admin/forum/category/edit/' . $list->id); ?>"
