	...
	<div class="uk-container">
		<div class="uk-grid uk-grid-small uk-margin-small" data-uk-grid>
			...
			<div class="uk-width-auto">
				<a href="<?= base_url('admin/forum/elements'); ?>" class="uk-icon-button"><i
		...
		<div class="uk-card uk-card-default">
			<div class="uk-card-body">
				...
				<div class="uk-margin-small">
					...
					<div class="uk-form-controls">
						<div class="uk-inline uk-width-1-1">
							...
							<input class="uk-input" type="text" id="forum_name"
								   value="<?= $this->admin_model->getSpecifyForumName($idlink); ?>"
				...
				<div class="uk-margin-small">
					...
					<div class="uk-form-controls">
						<div class="uk-inline uk-width-1-1">
							<input class="uk-input" type="text" id="forum_description"
								   value="<?= $this->admin_model->getSpecifyForumDesc($idlink); ?>"
								   placeholder="<?= $this->lang->line('placeholder_description'); ?>" required>
						</div>
					</div>
				</div>
				<div class="uk-margin-small">
					...
					<div class="uk-form-controls">
						<div class="uk-inline uk-width-1-1">
							<input class="uk-input" type="text" id="forum_icon"
								   value="<?= $this->admin_model->getSpecifyForumIcon($idlink); ?>"
				...
				<div class="uk-margin-small">
					...
					<div class="uk-form-controls">
						<select class="uk-select" id="forum_type">
							...
							<option
								value="1" <?php if ($this->admin_model->getSpecifyForumType($idlink) == '1') echo 'selected'; ?>><?= $this->lang->line('option_everyone'); ?></option>
							<option
								value="2" <?php if ($this->admin_model->getSpecifyForumType($idlink) == '2') echo 'selected'; ?>><?= $this->lang->line('option_staff'); ?></option>
							<option
								value="3" <?php if ($this->admin_model->getSpecifyForumType($idlink) == '3') echo 'selected'; ?>><?= $this->lang->line('option_all'); ?></option>
						</select>
					</div>
				</div>
				<div class="uk-margin-small">
				...
				<div class="uk-margin-small">
					<button class="uk-button uk-button-primary uk-width-1-1" type="submit" name="button_upforum"><i
