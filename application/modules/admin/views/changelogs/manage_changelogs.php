							...
							<tr>
								...
								<td>
									<div class="uk-flex uk-flex-left uk-flex-center@m uk-margin-small">
										<a href="<?= base_url('admin/changelogs/edit/' . $changelogs->id); ?>"
										   class="uk-button uk-button-primary uk-margin-small-right"><i
												class="fas fa-edit"></i></a>
										<button class="uk-button uk-button-danger" value="<?= $changelogs->id ?>"
												id="button_delete<?= $changelogs->id ?>"
												onclick="DeleteChangelog(event, this.value)"><i
