	...
	<div class="uk-container">
		<div class="uk-grid uk-grid-small uk-margin-small" data-uk-grid>
			<div class="uk-width-expand uk-heading-line">
				<h3 class="uk-h3"><i class="fas fa-edit"></i> <?= $this->lang->line('placeholder_edit_changelog'); ?>
				</h3>
			</div>
		...
		<div class="uk-card uk-card-default">
			<div class="uk-card-body">
					...
					<div class="uk-form-controls">
						<div class="uk-inline uk-width-1-1">
							...
							<input class="uk-input" type="text" id="changelog_title"
								   value="<?= $this->admin_model->getChangelogSpecifyName($idlink); ?>"
				...
				<div class="uk-margin-small">
					...
					<div class="uk-form-controls">
						<textarea class="uk-textarea tinyeditor" id="changelog_description"
								  rows="12"><?= $this->admin_model->getChangelogSpecifyDesc($idlink); ?></textarea>
					</div>
				</div>
				<div class="uk-margin-small">
					<button class="uk-button uk-button-primary uk-width-1-1" type="submit" id="button_upchangelog"><i
