	...
	<div class="uk-container">
		<div class="uk-grid uk-grid-small uk-margin-small" data-uk-grid>
			<div class="uk-width-expand uk-heading-line">
				<h3 class="uk-h3"><i
						class="fas fa-plus-circle"></i> <?= $this->lang->line('placeholder_create_realm'); ?></h3>
			</div>
			...
			<div class="uk-card-body">
				...
				<div class="uk-margin-small">
					...
					<div class="uk-form-controls">
						<input class="uk-input" type="number" id="realm_id" placeholder="Auth -> realmlist -> ID"
							   required>
					</div>
				</div>
				<div class="uk-margin-small">
				...
				<div class="uk-margin-small">
					<div class="uk-grid uk-grid-small" data-uk-grid>
						...
						<div class="uk-inline uk-width-1-2@s">
							...
							<div class="uk-form-controls">
								<input class="uk-input" type="password" id="soap_password" placeholder="ascent"
									   required>
							</div>
						</div>
					</div>
				...
				<div class="uk-margin-small">
					<div class="uk-grid uk-grid-small" data-uk-grid>
						<div class="uk-inline uk-width-1-2@s">
							...
							<div class="uk-form-controls">
								<input class="uk-input" type="text" id="character_hostname" placeholder="127.0.0.1"
									   required>
							</div>
						</div>
						<div class="uk-inline uk-width-1-2@s">
							...
							<div class="uk-form-controls">
								<input class="uk-input" type="text" id="character_database" placeholder="characters"
									   required>
							</div>
						</div>
					</div>
				...
				<div class="uk-margin-small">
					<button class="uk-button uk-button-primary uk-width-1-1" type="submit" name="button_realm"><i
