							...
							<tr>
								...
								<td>
									<div class="uk-flex uk-flex-left uk-flex-center@m uk-margin-small">
										<a href="<?= base_url('admin/realms/edit/' . $realmsID->id); ?>"
										   class="uk-button uk-button-primary uk-margin-small-right"><i
												class="fas fa-edit"></i></a>
										<button class="uk-button uk-button-danger" value="<?= $realmsID->id ?>"
												id="button_delete<?= $realmsID->id ?>"
												onclick="DeleteRealm(event, this.value)"><i
