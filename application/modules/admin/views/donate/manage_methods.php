	...
	<div class="uk-container">
		<div class="uk-grid uk-grid-small uk-margin-small" data-uk-grid>
			<div class="uk-width-expand uk-heading-line">
				<h3 class="uk-h3"><i class="fas fa-donate"></i> <?= $this->lang->line('admin_nav_donate_methods'); ?>
				</h3>
			</div>
			...
			<div class="uk-width-1-4@s">
				<div class="uk-card uk-card-secondary">
					<ul class="uk-nav uk-nav-default">
						<li class="uk-active"><a href="<?= base_url('admin/donate'); ?>"><i class="fas fa-donate"></i>
								PayPal Method</a></li>
					</ul>
				</div>
			</div>
								...
								<tr>
									...
									<td>
										<div class="uk-flex uk-flex-left uk-flex-center@m uk-margin-small">
											<a href="<?= base_url('admin/donate/edit/' . $donate->id); ?>"
											   class="uk-button uk-button-primary uk-margin-small-right"><i
													class="fas fa-edit"></i></a>
											<button class="uk-button uk-button-danger" value="<?= $donate->id ?>"
													id="button_delete<?= $donate->id ?>"
													onclick="DeletePlan(event, this.value)"><i
