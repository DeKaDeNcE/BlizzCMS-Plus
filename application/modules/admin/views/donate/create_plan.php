	...
	<div class="uk-container">
		...
		<div class="uk-card uk-card-default">
			<div class="uk-card-body">
							...
							<div class="uk-form-controls">
								<div class="uk-inline uk-width-1-1">
									<input class="uk-input" type="number" id="plan_price"
										   ...
										   value="1" step="0.01" pattern="^\d+(?:\.\d{1,2})?$" required>
								</div>
							</div>
						</div>
						<div class="uk-inline uk-width-1-3@s">
							...
							<div class="uk-form-controls">
								<div class="uk-inline uk-width-1-1">
									<input class="uk-input" type="number" id="plan_tax"
										   placeholder="<?= $this->lang->line('table_header_tax'); ?>" min="0" value="0"
				...
				<div class="uk-margin-small">
					<button class="uk-button uk-button-primary uk-width-1-1" type="submit" id="button_plan"><i
