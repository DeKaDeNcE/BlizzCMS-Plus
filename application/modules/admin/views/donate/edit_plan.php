	...
	<div class="uk-container">
		<div class="uk-grid uk-grid-small uk-margin-small" data-uk-grid>
			...
			<div class="uk-width-auto">
				<a href="<?= base_url('admin/donate'); ?>" class="uk-icon-button"><i
		...
		<div class="uk-card uk-card-default">
			<div class="uk-card-body">
				...
				<div class="uk-margin-small">
					...
					<div class="uk-form-controls">
						<div class="uk-inline uk-width-1-1">
							...
							<input class="uk-input" type="text" id="plan_name"
								   value="<?= $this->admin_model->getDonateSpecifyName($idlink); ?>"
				...
				<div class="uk-margin-small">
					<div class="uk-grid-small" uk-grid>
						<div class="uk-inline uk-width-1-3@s">
							...
							<div class="uk-form-controls">
								<div class="uk-inline uk-width-1-1">
									<input class="uk-input" type="number" id="plan_price"
										   placeholder="<?= $this->lang->line('table_header_price'); ?>" min="1"
										   value="<?= $this->admin_model->getDonateSpecifyPrice($idlink); ?>"
						...
						<div class="uk-inline uk-width-1-3@s">
							...
							<div class="uk-form-controls">
								<div class="uk-inline uk-width-1-1">
									<input class="uk-input" type="number" id="plan_tax"
										   placeholder="<?= $this->lang->line('table_header_tax'); ?>" min="0"
										   value="<?= $this->admin_model->getDonateSpecifyTax($idlink); ?>" step="0.01"
						...
						<div class="uk-inline uk-width-1-3@s">
							...
							<div class="uk-form-controls">
								<div class="uk-inline uk-width-1-1">
									<input class="uk-input" type="number" id="plan_points"
										   placeholder="<?= $this->lang->line('table_header_points'); ?>" min="1"
										   value="<?= $this->admin_model->getDonateSpecifyPoints($idlink); ?>" step="1"
										   required>
								</div>
							</div>
						</div>
				...
				<div class="uk-margin-small">
					<button class="uk-button uk-button-primary uk-width-1-1" type="submit" id="button_upplan"><i
