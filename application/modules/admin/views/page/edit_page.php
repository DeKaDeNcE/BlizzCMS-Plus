	...
	<div class="uk-container">
		<div class="uk-grid uk-grid-small uk-margin-small" data-uk-grid>
			...
			<div class="uk-width-auto">
				<a href="<?= base_url('admin/pages'); ?>" class="uk-icon-button"><i
				...
				<div class="uk-margin-small">
					...
					<div class="uk-form-controls">
						<div class="uk-inline uk-width-1-1">
							...
							<input class="uk-input" type="text" id="page_title"
								   value="<?= $this->admin_model->getPagesSpecifyName($idlink); ?>"
				...
				<div class="uk-margin-small">
					...
					<div class="uk-form-controls">
						<div class="uk-inline uk-width-1-1">
							...
							<input class="uk-input" type="text" id="page_uri"
								   value="<?= $this->admin_model->getPagesSpecifyURI($idlink); ?>"
								   placeholder="<?= $this->lang->line('placeholder_uri'); ?>" required>
						</div>
					</div>
				</div>
				<div class="uk-margin-small">
					...
					<div class="uk-form-controls">
						<textarea class="uk-textarea tinyeditor" id="page_description"
								  rows="12"><?= $this->admin_model->getPagesSpecifyDesc($idlink); ?></textarea>
					</div>
				</div>
				<div class="uk-margin-small">
					<button class="uk-button uk-button-primary uk-width-1-1" type="submit" id="button_uppage"><i
