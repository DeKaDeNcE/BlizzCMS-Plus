							...
							<tr>
								...
								<td>
									<div class="uk-flex uk-flex-left uk-flex-center@m uk-margin-small">
										<a href="<?= base_url('admin/pages/edit/' . $pages->id); ?>"
										   class="uk-button uk-button-primary uk-margin-small-right"><i
												class="fas fa-edit"></i></a>
										<button class="uk-button uk-button-danger" value="<?= $pages->id ?>"
												id="button_delete<?= $pages->id ?>"
												onclick="DeletePage(event, this.value)"><i class="fas fa-trash-alt"></i>
										</button>
									</div>
								</td>
							</tr>
