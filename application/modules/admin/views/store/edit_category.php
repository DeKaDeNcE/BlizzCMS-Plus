	...
	<div class="uk-container">
		<div class="uk-grid uk-grid-small uk-margin-small" data-uk-grid>
			<div class="uk-width-expand uk-heading-line">
				<h3 class="uk-h3"><i class="fas fa-edit"></i> <?= $this->lang->line('placeholder_edit_category'); ?>
				</h3>
			</div>
			<div class="uk-width-auto">
				<a href="<?= base_url('admin/store'); ?>" class="uk-icon-button"><i
		...
		<div class="uk-card uk-card-default">
			<div class="uk-card-body">
						...
						<div class="uk-inline uk-width-1-2@s">
							...
							<div class="uk-form-controls">
								<div class="uk-inline uk-width-1-1">
									...
									<input class="uk-input" type="text" id="store_category_name"
										   value="<?= $this->admin_model->getStoreCategoryName($idlink); ?>"
							...
							<div class="uk-form-controls">
								<select class="uk-select" id="store_category_realm">
									...
									<?php foreach ($this->wowrealm->getRealms()->result() as $MultiRealm): ?>
										<option
											value="<?= $MultiRealm->realmID ?>" <?php if ($this->admin_model->getStoreCategoryRealm($idlink) == $MultiRealm->realmID) echo 'selected'; ?>><?= $this->wowrealm->getRealmName($MultiRealm->realmID); ?></option>
									<?php endforeach; ?>
								</select>
							</div>
						</div>
				...
				<div class="uk-margin-small">
					...
					<div class="uk-form-controls">
						<div class="uk-inline uk-width-1-1">
							<input class="uk-input" type="text" id="store_category_route"
								   value="<?= $this->admin_model->getStoreCategoryRoute($idlink); ?>"
								   placeholder="<?= $this->lang->line('placeholder_route'); ?>" required>
						</div>
					</div>
				</div>
				<div class="uk-margin-small">
					<button class="uk-button uk-button-primary uk-width-1-1" type="submit" id="button_upgroup"><i
