	...
	<div class="uk-container">
		<div class="uk-grid uk-grid-small uk-margin-small" data-uk-grid>
			<div class="uk-width-expand uk-heading-line">
				<h3 class="uk-h3"><i
						class="fas fa-plus-circle"></i> <?= $this->lang->line('placeholder_create_category'); ?></h3>
			</div>
		...
		<div class="uk-card uk-card-default">
			<div class="uk-card-body">
							...
							<div class="uk-form-controls">
								<select class="uk-select" id="store_category_realm">
									...
									<?php foreach ($this->wowrealm->getRealms()->result() as $MultiRealm): ?>
										<option
											value="<?= $MultiRealm->realmID ?>"><?= $this->wowrealm->getRealmName($MultiRealm->realmID); ?></option>
									<?php endforeach; ?>
								</select>
							</div>
						</div>
				...
				<div class="uk-margin-small">
					...
					<div class="uk-margin-small">
						<button class="uk-button uk-button-primary uk-width-1-1" type="submit" id="button_group"><i
