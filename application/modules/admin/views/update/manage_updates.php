				...
				<div class="uk-card uk-card-secondary">
					<ul class="uk-nav uk-nav-default" uk-switcher="connect: #manage-updates">
						<li><a href="javascript:void(0)"><i
									class="fas fa-wrench"></i> <?= $this->lang->line('section_update_cms'); ?></a></li>
						<li><a href="javascript:void(0)"><i
									class="fas fa-tasks"></i> <?= $this->lang->line('section_check_information'); ?></a>
						</li>
					</ul>
				</div>
			</div>
							...
							<div class="uk-card-body">
								<div class="uk-grid uk-grid-small" data-uk-grid>
									<div class="uk-width-auto@m uk-text-center uk-text-left@m">
										<h3 class="uk-h3 uk-text-bold uk-margin-remove"><span
												uk-icon="icon: blizzcms-icon;ratio: 0.8"></span>
											V<?= $this->update_model->getCurrentVersion(); ?> </h3>
									...
									<div class="uk-width-expand uk-text-center uk-text-right@m">
										<button href="<?= base_url('admin/cms/update') ?>"
												class="uk-button uk-button-primary uk-button-large"
												id="button_updatecms" onclick="UpdateCMS(event)"><i
												class="fas fa-sync fa-spin"></i> <?= $this->lang->line('button_update_version'); ?>
										</button>
									</div>
								</div>
								<p class="uk-text-small uk-margin-small"><span class="uk-text-bold uk-text-warning"><i
											class="fas fa-exclamation-triangle"></i> <?= $this->lang->line('notification_title_warning'); ?>:</span> <?= $this->lang->line('cms_warning_update'); ?>
								</p>
							</div>
						</div>
					</li>
									...
									<tr>
										...
										<td>
											<?php if (ini_get('allow_url_fopen')): ?>
												<span
													class="uk-label uk-label-success"><?= $this->lang->line('option_on'); ?></span>
											<?php else: ?>
												<span
													class="uk-label uk-label-danger"><?= $this->lang->line('option_off'); ?></span>
											<?php endif; ?>
										</td>
									</tr>
									<tr>
