				...
				<div class="uk-card uk-card-default blizzcms-card-tab uk-card-small">
					...
					<div class="uk-card-body">
						<ul class="uk-tab-right"
							uk-tab="connect: #cms-verify; animation: uk-animation-fade; toggle: > *">
									...
									<div class="uk-grid uk-grid-small" data-uk-grid>
										<div class="uk-width-auto@m uk-text-center uk-text-left@m">
											<h3 class="uk-h3 uk-text-bold uk-margin-remove"><span
													uk-icon="icon: blizzcms-icon;ratio: 0.8"></span> <?= $this->update_model->getCurrentVersion() ?>
											</h3>
										...
										<div class="uk-width-expand uk-text-center uk-text-right@m">
											<a href="<?= base_url('admin/autoupdate') ?>"
											   class="uk-button uk-button-upgrade uk-button-large"><i
													class="fas fa-sync fa-spin"></i> Check recent updates</a>
										</div>
									</div>
									<p><span class="uk-text-bold uk-text-warning">Nota:</span> Al actualizar el CMS
										podrías perder algunos datos referentes a la configuración, almacenados en
