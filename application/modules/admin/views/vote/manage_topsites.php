	...
	<div class="uk-container">
		<div class="uk-grid uk-grid-small uk-margin-small" data-uk-grid>
			...
			<div class="uk-width-auto">
				<a href="<?= base_url('admin/topsites/create'); ?>" class="uk-icon-button"><i
			...
			<div class="uk-overflow-auto">
				<table class="uk-table uk-table-middle uk-table-divider uk-table-small">
					...
					<tr>
						...
						<th class="uk-width-small uk-text-center"><?= $this->lang->line('table_header_time'); ?> <span
								class="uk-text-bold">(<?= $this->lang->line('placeholder_hours'); ?>)</span></th>
							...
							<tr>
								...
								<td>
									<div class="uk-flex uk-flex-left uk-flex-center@m uk-margin-small">
										<a href="<?= base_url('admin/topsites/edit/' . $topsites->id); ?>"
										   class="uk-button uk-button-primary uk-margin-small-right"><i
												class="fas fa-edit"></i></a>
										<button class="uk-button uk-button-danger" value="<?= $topsites->id ?>"
												id="button_delete<?= $topsites->id ?>"
												onclick="DeleteTopsite(event, this.value)"><i
