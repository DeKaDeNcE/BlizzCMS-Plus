			...
			<div class="uk-width-1-4@s">
				<div class="uk-card uk-card-secondary">
					<ul class="uk-nav uk-nav-default">
						...
						<li class="uk-active"><a href="<?= base_url('admin/settings/module'); ?>"><i
				...
				<div class="uk-card uk-card-default uk-margin-small">
					<div class="uk-card-body">
						<h5 class="uk-h5 uk-heading-line uk-text-uppercase uk-text-bold uk-text-center uk-margin-small">
							<span><?= $this->lang->line('section_module_settings'); ?></span></h5>
						...
						<div class="uk-margin-small">
							<div class="uk-grid uk-grid-small" data-uk-grid>
								<div class="uk-width-1-2@s">
									<label
										class="uk-form-label"><?= $this->lang->line('conf_paypal_currency'); ?></label>
									<div class="uk-form-controls">
										<div class="uk-inline uk-width-1-1">
											<span class="uk-form-icon uk-form-icon-flip"><i
													class="fas fa-file-invoice-dollar"></i></span>
											<input class="uk-input" type="text" id="paypal_currency"
												   value="<?= $this->config->item('paypal_currency'); ?>" required>
										</div>
									</div>
								</div>
								<div class="uk-width-1-2@s">
									...
									<div class="uk-form-controls">
										<select class="uk-select" id="paypal_mode">
											<option
												value="sandbox" <?php if ($this->config->item('paypal_mode') == 'sandbox') echo 'selected'; ?>>
												Sandbox
											</option>
											<option
												value="live" <?php if ($this->config->item('paypal_mode') == 'live') echo 'selected'; ?>>
												Live
											</option>
										</select>
									</div>
						...
						<div class="uk-margin-small">
							...
							<div class="uk-form-controls">
								<div class="uk-inline uk-width-1-1">
									...
									<input class="uk-input" type="text" id="paypal_client"
										   value="<?= $this->config->item('paypal_userid'); ?>" required>
								</div>
							</div>
						</div>
						<div class="uk-margin-small">
							...
							<div class="uk-form-controls">
								<div class="uk-inline uk-width-1-1">
									<span class="uk-form-icon uk-form-icon-flip"><i class="fas fa-key"></i></span>
									<input class="uk-input" type="text" id="paypal_password"
										   value="<?= $this->config->item('paypal_secretpass'); ?>" required>
								</div>
							</div>
						</div>
						<div class="uk-margin">
							<button class="uk-button uk-button-primary uk-width-1-1" type="submit" id="button_update"><i
						...
						<div class="uk-margin-small">
							...
							<div class="uk-form-controls">
								<div class="uk-width-1-1">
									<textarea class="uk-textarea tinyeditor" rows="12"
											  id="bugtracker_description"><?= $this->config->item('textarea'); ?></textarea>
								</div>
							</div>
						</div>
						<div class="uk-margin">
