	...
	<div class="uk-container">
		<div class="uk-grid uk-grid-small uk-margin-small" data-uk-grid>
			<div class="uk-width-expand uk-heading-line">
				<h3 class="uk-h3"><i
						class="fas fa-sliders-h"></i> <?= $this->lang->line('admin_nav_manage_settings'); ?></h3>
			</div>
			...
			<div class="uk-width-1-4@s">
				<div class="uk-card uk-card-secondary">
					<ul class="uk-nav uk-nav-default">
						<li><a href="<?= base_url('admin/settings'); ?>"><i
									class="fas fa-cog"></i> <?= $this->lang->line('section_general_settings'); ?></a>
						</li>
						<li><a href="<?= base_url('admin/settings/module'); ?>"><i
									class="fas fa-puzzle-piece"></i> <?= $this->lang->line('section_module_settings'); ?>
							</a></li>
						<li class="uk-active"><a href="<?= base_url('admin/settings/optional'); ?>"><i
									class="fas fa-layer-group"></i> <?= $this->lang->line('section_optional_settings'); ?>
							</a></li>
						<li><a href="<?= base_url('admin/settings/seo'); ?>"><i
									class="fas fa-search"></i> <?= $this->lang->line('section_seo_settings'); ?></a>
						</li>
					</ul>
				</div>
			</div>
				...
				<div class="uk-card uk-card-default uk-margin-small">
					<div class="uk-card-body">
						<h5 class="uk-h5 uk-heading-line uk-text-uppercase uk-text-bold uk-text-center uk-margin-small">
							<span><?= $this->lang->line('section_optional_settings'); ?></span></h5>
								...
								<div class="uk-width-1-2@s">
									...
									<div class="uk-form-controls">
										<div class="uk-inline uk-width-1-1">
											...
											<input class="uk-input" type="text" id="admin_level"
												   value="<?= $this->config->item('admin_access_level'); ?>" required>
										</div>
									</div>
								</div>
								<div class="uk-width-1-2@s">
									...
									<div class="uk-form-controls">
										<div class="uk-inline uk-width-1-1">
											...
											<input class="uk-input" type="text" id="mod_level"
												   value="<?= $this->config->item('mod_access_level'); ?>" required>
										</div>
									</div>
								</div>
							</div>
						</div>
						<h5 class="uk-h5 uk-heading-bullet uk-text-uppercase uk-text-bold uk-margin-top uk-margin-small-bottom">
							reCaptcha</h5>
						<div class="uk-margin-small">
							...
							<div class="uk-form-controls">
								<div class="uk-inline uk-width-1-1">
									...
									<input class="uk-input" type="text" id="recaptcha_key"
										   value="<?= $this->config->item('recaptcha_sitekey'); ?>">
								</div>
							</div>
						</div>
						...
						<div class="uk-alert-danger uk-margin-small" uk-alert>
							<p>
								<i class="fas fa-exclamation-circle"></i> <?= $this->lang->line('alert_smtp_activation'); ?>
							</p>
						</div>
						<div class="uk-margin-small">
							...
							<div class="uk-form-controls">
								<select class="uk-select" id="register_type">
									<option
										value="TRUE" <?php if ($this->config->item('account_activation_required') == TRUE) echo 'selected'; ?>><?= $this->lang->line('option_enabled'); ?></option>
									<option
										value="FALSE" <?php if ($this->config->item('account_activation_required') == FALSE) echo 'selected'; ?>><?= $this->lang->line('option_disabled'); ?></option>
								</select>
							</div>
						</div>
						<h5 class="uk-h5 uk-heading-bullet uk-text-uppercase uk-text-bold uk-margin-top uk-margin-small-bottom">
						...
						<div class="uk-margin-small">
							<div class="uk-grid uk-grid-small" data-uk-grid>
								<div class="uk-width-1-2@s">
									...
									<div class="uk-form-controls">
										<div class="uk-inline uk-width-1-1">
											...
											<input class="uk-input" type="text" id="smtp_hostname"
								...
								<div class="uk-width-1-4@s">
									...
									<div class="uk-form-controls">
										<div class="uk-inline uk-width-1-1">
											<input class="uk-input" type="number" id="smtp_port"
								...
								<div class="uk-width-1-4@s">
									<label
										class="uk-form-label"><?= $this->lang->line('conf_smtp_encryption'); ?></label>
									<div class="uk-form-controls">
										<select class="uk-select" id="smtp_crypto">
											<option
												value="ssl" <?php if ($this->config->item('smtp_crypto') == 'ssl') echo 'selected'; ?>><?= $this->lang->line('option_ssl'); ?></option>
											<option
												value="tls" <?php if ($this->config->item('smtp_crypto') == 'tls') echo 'selected'; ?>><?= $this->lang->line('option_tls'); ?></option>
										</select>
									</div>
								</div>
							</div>
								...
								<div class="uk-width-1-2@s">
									...
									<div class="uk-form-controls">
										<div class="uk-inline uk-width-1-1">
											...
											<input class="uk-input" type="text" id="smtp_username"
								...
								<div class="uk-width-1-2@s">
									...
									<div class="uk-form-controls">
										<div class="uk-inline uk-width-1-1">
											...
											<input class="uk-input" type="password" id="smtp_password"
								...
								<div class="uk-width-1-2@s">
									...
									<div class="uk-form-controls">
										<div class="uk-inline uk-width-1-1">
											...
											<input class="uk-input" type="email" id="sender_email"
												   value="<?= $this->config->item('email_settings_sender'); ?>">
										</div>
									</div>
								</div>
								<div class="uk-width-1-2@s">
									...
									<div class="uk-form-controls">
										<div class="uk-inline uk-width-1-1">
											...
											<input class="uk-input" type="text" id="sender_name"
												   value="<?= $this->config->item('email_settings_sender_name'); ?>">
										</div>
									</div>
								</div>
							</div>
						...
						<div class="uk-margin">
							<button class="uk-button uk-button-primary uk-width-1-1" type="submit" id="button_optional">
								<i class="fas fa-sync"></i> <?= $this->lang->line('button_update'); ?></button>
						</div>
						<?= form_close(); ?>
					</div>
				</div>
