	...
	<div class="uk-container">
		<div class="uk-grid uk-grid-small uk-margin-small" data-uk-grid>
			<div class="uk-width-expand uk-heading-line">
				<h3 class="uk-h3"><i
						class="fas fa-puzzle-piece"></i> <?= $this->lang->line('admin_nav_manage_modules'); ?></h3>
			</div>
						...
						<tr>
							...
							<td class="uk-text-center" uk-margin>
								<?php if ($module->status == 1): ?>
									<button class="uk-button uk-button-danger" value="<?= $module->id ?>"
											id="button_disable<?= $module->id ?>"
											onclick="DisableModule(event, this.value)"><i class="fas fa-eye-slash"></i>
									</button>
								<?php else: ?>
									<button class="uk-button uk-button-primary" value="<?= $module->id ?>"
											id="button_enable<?= $module->id ?>"
											onclick="EnableModule(event, this.value)"><i class="fas fa-eye"></i>
									</button>
								<?php endif; ?>
							</td>
						</tr>
