							...
							<tr>
								<td>
									<img class="uk-preserve-width uk-border-rounded"
										 src="<?= base_url('assets/images/profiles/' . $this->wowauth->getNameAvatar($account->profile)); ?>"
										 alt="Avatar" width="36">
								...
								<td>
									<div class="uk-flex uk-flex-left uk-flex-center@m uk-margin-small">
										<a href="<?= base_url('admin/account/manage/' . $account->id); ?>"
										   class="uk-button uk-button-primary uk-margin-small-right"><i
												class="fas fa-user-edit"></i></a>
										<a href="<?= base_url('admin/account/dlogs/' . $account->id); ?>"
										   class="uk-button uk-button-primary"><i class="fas fa-donate"></i></a>
									</div>
								</td>
							</tr>
						<?php endforeach; ?>
