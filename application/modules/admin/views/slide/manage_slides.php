							...
							<tr>
								...
								<td>
									<div class="uk-flex uk-flex-left uk-flex-center@m uk-margin-small">
										<a href="<?= base_url('admin/slides/edit/' . $slides->id); ?>"
										   class="uk-button uk-button-primary uk-margin-small-right"><i
												class="fas fa-edit"></i></a>
										<button class="uk-button uk-button-danger" value="<?= $slides->id ?>"
												id="button_delete<?= $slides->id ?>"
												onclick="DeleteSlide(event, this.value)"><i
