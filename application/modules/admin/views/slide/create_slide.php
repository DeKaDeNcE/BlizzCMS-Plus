	...
	<div class="uk-container">
		<div class="uk-grid uk-grid-small uk-margin-small" data-uk-grid>
			<div class="uk-width-expand uk-heading-line">
				<h3 class="uk-h3"><i
						class="fas fa-plus-circle"></i> <?= $this->lang->line('placeholder_create_slide'); ?></h3>
			</div>
		...
		<div class="uk-card uk-card-default">
			<div class="uk-card-body">
				...
				<div class="uk-margin-small">
					<div class="uk-grid uk-grid-small" data-uk-grid>
						...
						<div class="uk-inline uk-width-2-3@s">
							...
							<div class="uk-form-controls">
								<input class="uk-input" type="text" id="slide_route" placeholder="URL or Image Name"
									   required>
							</div>
						</div>
					</div>
				...
				<div class="uk-margin-small">
					<button class="uk-button uk-button-primary uk-width-1-1" type="submit" id="button_slide"><i
