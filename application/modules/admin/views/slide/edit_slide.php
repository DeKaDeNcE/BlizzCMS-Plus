	...
	<div class="uk-container">
		<div class="uk-grid uk-grid-small uk-margin-small" data-uk-grid>
			...
			<div class="uk-width-auto">
				<a href="<?= base_url('admin/slides'); ?>" class="uk-icon-button"><i
		...
		<div class="uk-card uk-card-default">
			<div class="uk-card-body">
				...
				<div class="uk-margin-small">
					...
					<div class="uk-form-controls">
						<div class="uk-inline uk-width-1-1">
							<input class="uk-input" type="text" id="slide_title"
								   value="<?= $this->admin_model->getSlideSpecifyTitle($idlink); ?>"
				...
				<div class="uk-margin-small">
					...
					<div class="uk-form-controls">
						<textarea class="uk-textarea" id="slide_description"
								  rows="3"><?= $this->admin_model->getSlideSpecifyDescription($idlink); ?></textarea>
					</div>
				</div>
				<div class="uk-margin-small">
					<div class="uk-grid uk-grid-small" data-uk-grid>
						<div class="uk-inline uk-width-1-3@s">
							...
							<div class="uk-form-controls">
								<select class="uk-select" id="slide_type">
									...
									<option
										value="1" <?php if ($this->admin_model->getSlideSpecifyType($idlink) == '1') echo 'selected'; ?>><?= $this->lang->line('option_image'); ?></option>
									<option
										value="2" <?php if ($this->admin_model->getSlideSpecifyType($idlink) == '2') echo 'selected'; ?>><?= $this->lang->line('option_video'); ?></option>
									<option
										value="3" <?php if ($this->admin_model->getSlideSpecifyType($idlink) == '3') echo 'selected'; ?>><?= $this->lang->line('option_iframe'); ?></option>
								</select>
							</div>
						</div>
						<div class="uk-inline uk-width-2-3@s">
							...
							<div class="uk-form-controls">
								<input class="uk-input" type="text" id="slide_route"
									   value="<?= $this->admin_model->getSlideSpecifyRoute($idlink); ?>"
									   placeholder="URL or Image Name" required>
							</div>
						</div>
					</div>
				</div>
				<div class="uk-margin-small">
					<button class="uk-button uk-button-primary uk-width-1-1" type="submit" id="button_upslide"><i
