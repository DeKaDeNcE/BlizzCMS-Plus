						...
						<div class="uk-grid uk-grid-small">
							<div class="uk-width-expand@m">
								<h4 class="uk-h4 uk-text-uppercase uk-text-bold"><i
										class="fas fa-bug"></i> <?= $this->lang->line('placeholder_create_bug_report'); ?>
								</h4>
							</div>
							<div class="uk-width-auto@m">
								<a href="<?= base_url('bugtracker'); ?>"
					...
					<div class="uk-card-body">
						...
						<div class="uk-margin uk-light">
							...
							<div class="uk-form-controls">
								<div class="uk-inline uk-width-1-1">
									...
									<input class="uk-input" type="text" id="report_title"
						...
						<div class="uk-margin uk-light">
							<div class="uk-grid uk-grid-small" data-uk-grid>
								<div class="uk-inline uk-width-1-2@s">
									...
									<div class="uk-form-controls">
										<select class="uk-select" id="report_type">
											<option
												value="0"><?= $this->lang->line('notification_select_type'); ?></option>
								...
								<div class="uk-inline uk-width-1-2@s">
									<label
										class="uk-form-label"><?= $this->lang->line('table_header_priority'); ?></label>
									<div class="uk-form-controls">
										<select class="uk-select" id="report_priority">
											<option
												value="0"><?= $this->lang->line('notification_select_priority'); ?></option>
											<?php foreach ($this->bugtracker_model->getPriorities()->result() as $priorities): ?>
												<option
													value="<?= $priorities->id; ?>"><?= $priorities->title ?></option>
											<?php endforeach; ?>
										</select>
									</div>
								</div>
						...
						<div class="uk-margin uk-light">
							...
							<div class="uk-form-controls">
								<div class="uk-width-1-1">
									<textarea class="uk-textarea tinyeditor" id="report_description"
											  rows="12"></textarea>
								</div>
							</div>
						</div>
						<div class="uk-margin">
							<button class="uk-button uk-button-default uk-width-1-1" id="button_report" type="submit"><i
									class="fas fa-plus-circle"></i> <?= $this->lang->line('button_create'); ?></button>
						</div>
						<?= form_close(); ?>
					</div>
				</div>
