...
$route[$lang.'/profile/(:num)'] = 'user/viewing_profile/$2';
...
$route[$lang.'/forum/topic/edit/(:num)'] = 'forum/editopic/$2';
...
$route[$lang.'/admin/settings'] = 'admin/managesettings';
...
$route[$lang.'/admin/permissions'] = 'admin/manageRank';
$route[$lang.'/admin/permissions/manage/(:num)'] = 'admin/viewRank/$2';
